; C:\M68KV6.0 - 800BY48\PROGRAMS\DEBUGMONITORCODE\M68KDEBUG (NO DISASSEMBLER).C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; //
; /*******************************************************************
; ** Tell chip to disable blocks writes
; ********************************************************************/
; void DisableBlock(){
       xdef      _DisableBlock
_DisableBlock:
...
; unsigned char  c;
; unsigned char Address1,Address2,Address3;
; int FlashAddress = 0;
       clr.l     D5
; int i_1=0; //counter
       clr.l     D4
...
; //printf("\r\nEntered the loop_0");
; Address1 = ( FlashAddress>>16 ) & 0xFF;
       move.l    D5,D0
       asr.l     #8,D0
       asr.l     #8,D0
       and.l     #255,D0
       move.b    D0,-3(A6)
; Address2 = ( FlashAddress>>8 ) & 0xFF;
       move.l    D5,D0
       asr.l     #8,D0
       and.l     #255,D0
       move.b    D0,-2(A6)
; Address3 = ( FlashAddress ) & 0xFF;
       move.l    D5,D0
       and.l     #255,D0
       move.b    D0,-1(A6)
; DisableBlock();
...
; printf("\r\nFlash chip is programmed!");
       ...
       addq.w    #4,A7
; FlashMemoryTest();
       jsr       _FlashMemoryTest
       movem.l   (A7)+,D2/D3/D4/D5/A2/A3
       unlk      A6
       rts
; }
; void FlashMemoryTest(void){
       xdef      _FlashMemoryTest
_FlashMemoryTest:
       link      A6,#-4
...
FlashMemoryTest_1:
       cmp.l     #134479872,D2
       bhi       FlashMemoryTest_3
; SPI_Data = 0xFF; //Dummy DATA
       move.b    #255,4227108
; WaitForSPITransmitComplete();
       jsr       (A2)
; test_byte=SPI_Data;
...
; Disable_SPI_CS();
       move.b    #255,4227112
; return;
       bra.s     FlashMemoryTest_6
FlashMemoryTest_4:
       addq.l    #1,D2
       bra       FlashMemoryTest_1
FlashMemoryTest_3:
; }
; }
; Disable_SPI_CS();
...
; printf("\r\nStart Address: ") ;
       ...
       jsr       (A2)
       addq.w    #4,A7
; Start = Get8HexDigits(0) ; //Prompt the user for the start address.
       clr.l     -(A7)
       jsr       _Get8HexDigits
       addq.w    #4,A7
       move.l    D0,D4
; printf("\r\nEnd Address: ") ;
       ...
       jsr       (A2)
       addq.w    #4,A7
; End = Get8HexDigits(0) ; //Prompt the user for end address
       clr.l     -(A7)
       jsr       _Get8HexDigits
       addq.w    #4,A7
       move.l    D0,D3
...
; char c ;
; int i, j ;
; char *BugMessage = "Name= Atahan Akar";
       lea       @m68kde~1_153.L,A0
       move.l    A0,-8(A6)
; char *CopyrightMessage = "Student Number = 20301727";
...
@m68kde~1_22:
       dc.b      13,10,69,114,97,115,101,100,32,116,104,101,32
       dc.b      99,104,105,112,0
@m68kde~1_23:
       dc.b      13,10,76,101,116,39,115,32,114,117,110,32,116
       dc.b      104,101,32,80,114,111,103,114,97,109,70,108
       dc.b      97,115,104,67,104,105,112,40,41,0
@m68kde~1_24:
       dc.b      10,13,10,32,65,100,100,114,101,115,115,32,61
       dc.b      32,37,120,32,68,79,78,69,33,32,0
@m68kde~1_25:
       dc.b      13,10,70,108,97,115,104,32,99,104,105,112,32
       dc.b      105,115,32,112,114,111,103,114,97,109,109,101
       dc.b      100,33,0
@m68kde~1_26:
       dc.b      13,10,70,97,105,108,101,100,0
@m68kde~1_27:
       dc.b      13,10,84,104,101,32,98,121,116,101,32,110,117
       dc.b      109,98,101,114,32,37,100,32,105,115,32,119,114
       dc.b      111,110,103,0
@m68kde~1_28:
       dc.b      13,10,32,70,108,97,115,104,32,77,101,109,111
       dc.b      114,121,32,84,101,115,116,32,83,117,99,99,101
       dc.b      115,102,117,108,32,33,0
@m68kde~1_29:
       dc.b      13,10,32,76,111,97,100,105,110,103,32,102,114
       dc.b      111,109,32,70,108,97,115,104,32,67,104,105,112
       dc.b      32,46,46,46,0
@m68kde~1_30:
       dc.b      13,10,76,111,97,100,105,110,103,32,102,114,111
       dc.b      109,32,67,104,105,112,32,105,115,32,83,117,99
       dc.b      99,101,115,102,117,108,33,0
@m68kde~1_31:
...
@m68kde~1_147:
       ...
       dc.b      117,0
@m68kde~1_148:
       dc.b      13,10,69,120,112,101,99,116,101,100,32,100,97
       dc.b      116,97,32,61,32,37,117,0
@m68kde~1_149:
       dc.b      13,10,67,117,114,114,101,110,116,32,100,97,116
       dc.b      97,32,61,32,37,117,0
@m68kde~1_150:
...
@m68kde~1_152:
       dc.b      77,101,109,111,114,121,32,84,101,115,116,32
       dc.b      80,97,115,115,101,100,33,0
@m68kde~1_153:
       dc.b      78,97,109,101,61,32,65,116,97,104,97,110,32
       dc.b      65,107,97,114,0
@m68kde~1_154:
       dc.b      83,116,117,100,101,110,116,32,78,117,109,98
       dc.b      101,114,32,61,32,50,48,51,48,49,55,50,55,0
@m68kde~1_155:
...
@m68kde~1_158:
       dc.b      13,10,37,115,0
@m68kde~1_159:
       dc.b      78,97,109,101,61,32,83,111,110,103,122,104,117
       dc.b      32,90,104,97,110,103,0
@m68kde~1_160:
       dc.b      83,116,117,100,101,110,116,32,78,117,109,98
       dc.b      101,114,32,61,32,49,48,54,49,54,49,54,55,0
       section   bss
       xdef      _i
_i:
       ds.b      4
