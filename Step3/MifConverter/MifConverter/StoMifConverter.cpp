...
int main(int argc, char* argv[])
{
	...
	if ((SourceFilePtr = fopen("C:\\M68kV6.0 - 800by48\\Newest\\m68kdebugmonitor.hex", "r")) == NULL) {
	...
	if ((DestFilePtr = fopen("C:\\M68kV6.0 - 800by48\\Programs\\DebugMonitorCode\\M68kdebugmonitor.mif", "w")) == NULL) {
