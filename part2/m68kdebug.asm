; C:\M68KV6.0 - 800BY48\PROGRAMS\DEBUGMONITORCODE\M68KDEBUG.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; unsigned int data;
; unsigned int data_l,data_w,data_b;
; unsigned char *ptr_b= 0x00000000;
       moveq     #0,D7
; unsigned char *ptr_w= 0x00000000;
       clr.l     D6
; unsigned char *ptr_l= 0x00000000;
       clr.l     D4
; unsigned int test;
; char c ;
; printf("\r\nStart Address: ") ;
...
; Start = Get8HexDigits(0) ;
       ...
       addq.w    #4,A7
       move.l    D0,D2
; while(Start<0x08020000 & Start>0x08030000)
MemoryTest_1:
       cmp.l     #134348800,D2
       bhs.s     MemoryTest_4
       moveq     #1,D0
...
; End = Get8HexDigits(0) ;
       ...
       addq.w    #4,A7
       move.l    D0,D3
; while(End<0x08020000 & End>0x08030000)
MemoryTest_8:
       cmp.l     #134348800,D3
       bhs.s     MemoryTest_11
       moveq     #1,D0
