; C:\M68KV6.0 - 800BY48\PROGRAMS\USERPROGRAM\SPI_USER_PROGRAM.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
; #include <stdio.h>
; #include <string.h>
; #include <ctype.h>
; //IMPORTANT
...
; unsigned char *ptr_b =0x08020000;
       move.l    #134348800,-16(A6)
; unsigned char *ptr_w= 0x08020000;
       move.l    #134348800,-12(A6)
; unsigned char *ptr_l= 0x08020000;
       move.l    #134348800,-8(A6)
; unsigned int data;
...
; printf("Hello CPEN 412 Student") ; //Not needed
       pea       @spi_us~1_1.L
       jsr       _printf
       addq.w    #4,A7
