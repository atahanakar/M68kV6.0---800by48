...
; unsigned int row, i=0, count=0, counter1=1;
       ...
       clr.l     -176(A6)
       move.l    #1,-172(A6)
; char c, text[150],data ;
; int *start_address=0;
       clr.l     -16(A6)
; int *finish_address=0;
       clr.l     -12(A6)
; int PassFailFlag = 1 ;
       move.l    #1,-8(A6)
; int test=0;
...
; else if (test==32){
       ...
       cmp.l     #32,D0
       bne.s     main_5
; printf("55555555, AAAAAAAAA, FFFFFFFF, 00000000 \n");
       pea       @m68kus~1_8.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r Choose one of them:");
...
@m68kus~1_3:
       dc.b      37,100,0
@m68kus~1_4:
       dc.b      53,53,44,32,65,65,44,32,70,70,44,32,48,48,32
       dc.b      10,32,0
@m68kus~1_5:
       dc.b      13,32,67,104,111,111,115,101,32,111,110,101
       dc.b      32,111,102,32,116,104,101,109,58,0
@m68kus~1_6:
       dc.b      37,115,0
@m68kus~1_7:
       dc.b      53,53,53,53,44,32,65,65,65,65,44,32,70,70,70
       dc.b      70,44,32,48,48,48,48,0
@m68kus~1_8:
       dc.b      53,53,53,53,53,53,53,53,44,32,65,65,65,65,65
       dc.b      65,65,65,65,44,32,70,70,70,70,70,70,70,70,44
       dc.b      32,48,48,48,48,48,48,48,48,32,10,0
@m68kus~1_9:
